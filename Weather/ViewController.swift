...
//  Weather
//
//  Created by EunYupp Kim on 2022/03/18.
//
...
class ViewController: UIViewController {
    ...
    func showAlert(message: String) {
        ...
        alert.addAction(UIAlertAction(title: "에러", style: .default, handler: nil))
        self.present(alert, animated: true, completion: nil)
    }
    
    func getCurrentWeather(cityName: String) {
        guard let url = URL(string: "https://api.openweathermap.org/data/2.5/weather?q=\(cityName)&appid=73d275c39182f0aa8e54aeeb3ca945cf") else {
            return }
